...
public class Lambda03 {
    public static void main(String[] args) {
       ...
       int sum =  getSumFromSeventoSeventy();
        ...
        int sum1 = getMultiplicationFromThreeToNine();
        System.out.println(sum1); // 181440

        System.out.println(getMultiplicationFromThreeToNine2()); // 181440

        System.out.println(getFactorial(-1)); // -1 kabulu yaptik
    ...
    public static int getMultiplicationFromThreeToNine(){
        return IntStream.rangeClosed(3,9).//iki parametre dahil
    ...
    public static int getFactorial(int x ){
        ...
        //yer degistirme algoritmasi
            if (a >b){
                ...
                a = b ;
                b = temp; // aradaki kopruyu sagliyor temp
