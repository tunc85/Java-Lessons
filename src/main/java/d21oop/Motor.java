 ...
 uzerinden ulasildigi icin sorun olmaz.
  ...
  /*7) Normalde interface icine concrete method konulamaz ama bazi özel durumlarda concrete
    ...
    void run();
     ...
     int fiyat = 2000; // public static int fiyat = 2000;

    int fiyat2 =300; // 6

    default void guc(){ // buradaki default access modifier degildir , keyworddur. // 7 madde
        System.out.println("200HP");
    }

    static void hiz(){ // buradaki static bildigimiz static // 7 madde
