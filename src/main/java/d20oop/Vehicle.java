...
public class Vehicle {
    ...
    /* Child class'tan bir object olusturdugunuzda constructor'lar en ustteki
     parent class'tan baslatilarak alta doğru calistirilir */
...
class özelliklerini miras alır ve kendi özelliklerini ekler*/
    ...
    public Vehicle(){
        this("m",2,"m");
        System.out.println("Honda, 2023, Bezin");
