...
public class Student {
    ...
    public int getAge() {
        return age; // this.age'de yazabilirdik

        //2- age ve successful datalarini degistirebilir yapalim set method yeni data uretmez , var olan
        //data'yi degistirir bu yuzden returm type'lari hep void olur
