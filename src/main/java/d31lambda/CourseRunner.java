...
public class CourseRunner {
    public static void main(String[] args) {
        ...
        String name1 = coursesList.
                stream().max(Comparator.comparing(Course::getAvarageScore)).get().getCourseName();
        System.out.println(name1); // Turkish Night
        ...
        System.out.println(myList);
            //[Course{season='Summer', courseName='Turkish Day', avarageScore=97, numberOfStudents=128}, Course{season='Winter',
            // courseName='Turkish Night', avarageScore=98, numberOfStudents=154}]
        ...
        //ODEV //7)Average score’u en yuksek olan kursun ismini console yazdiran kodu yaziniz. limit 1 kullanarak cozelim
        ...
        List<Course> ourList= coursesList.stream().
        ...
        long howManyCourses= coursesList.
                stream().
                filter(t-> t.getCourseName().
                        contains("English")).count();
        System.out.println(howManyCourses); // 2

        //12) Ogrenci sayisi 140’tan az olan kurslari bir liste halinde veren kodu yaziniz

       List<Course> lessThan= coursesList.stream().filter(t-> t.getNumberOfStudents()< 140).collect(Collectors.toList());
